...
document.querySelector('#book-form').addEventListener('submit', (e) => {
    ...
    if(title === '' || author === '' || pages === '' || topic === ''){
        UI.showAlert('Nem töltöttél ki minden mezőt!', 'danger');
    }
    else{
        const book = new Book(title, author, pages, topic);
        UI.addBookToList(book);
        Store.addBook(book);

        UI.showAlert('Sikeres hozzáadás!','success');
...
document.querySelector('#book-list').addEventListener('click', (e) => {
    ...
    UI.showAlert('Sikeres törlés!','success');
});